...
func (c *OpsRampClient) GetInboundEntityProperties(tenantId string, integrationId string, entity string) ([]InboundEntityProperty, error) {
	...
	var response []InboundEntityProperty
	if err := json.Unmarshal(body, &response); err != nil {
		return nil, err
	}
